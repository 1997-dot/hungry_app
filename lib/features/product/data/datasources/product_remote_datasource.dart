    ...
    return ProductModel(
      ...
      availableToppings: [
        const ToppingModel(
          id: '1',
          name: 'Tomatos',
          imageUrl: 'assets/images/toppings/tomato.png',
          price: 0.5,
        ),
        const ToppingModel(
          id: '2',
          name: 'Lemons',
          imageUrl: 'assets/images/toppings/lemon.png',
          price: 0.3,
        ),
        const ToppingModel(
          id: '3',
          name: 'Onions',
          imageUrl: 'assets/images/toppings/onions.png',
          price: 0.4,
        ),
        const ToppingModel(
          id: '4',
          name: 'Cheese',
          imageUrl: 'assets/images/toppings/cheese.png',
          price: 0.3,
        ),
      ],
      availableSideOptions: [
        ...
        const SideOptionModel(
          id: '2',
          name: 'Cucumber',
          imageUrl: 'assets/images/sides/cucumber.png',
          price: 3.0,
        ),
        const SideOptionModel(
          id: '3',
          name: 'Coleslaw',
          imageUrl: 'assets/images/sides/coleslaw.png',
          price: 2.0,
        ),
        const SideOptionModel(
          id: '4',
          name: 'Salad',
          imageUrl: 'assets/images/sides/salad.png',
          price: 1.5,
        ),
      ],
      spicyLevel: 0.3,
